...
#ifndef AVR_DEBUG
	IMPLEMENT_ISR(INT0_vect, EXTERNAL_INT_0)
  // max.gerhardt: If AVR_DEBUG is not used, both interrupts are accessible with attachInterrupt
	IMPLEMENT_ISR(INT1_vect, EXTERNAL_INT_1)
#else
  // if we are using AVR_DEBUG, then we still want to have access to the interrupt by D3.
	IMPLEMENT_ISR(INT1_vect, EXTERNAL_INT_1)
#endif
